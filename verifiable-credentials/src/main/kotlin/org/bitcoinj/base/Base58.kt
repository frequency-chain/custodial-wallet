...
// NOTE(Julian, 2024-09-13): Pulling in this file directly since the current version of the `bitcoinj` library
// brings in transitive dependencies that are flagged with CVEs.
 ...
 *
 *
 * You may want to consider working with `org.bitcoinj.core.EncodedPrivateKey` instead, which
