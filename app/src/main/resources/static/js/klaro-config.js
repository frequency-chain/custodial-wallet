...
var klaroConfig = {
    ...
    cookieName: "FrequencyAccessCookieConsent",
    ...
    privacyPolicy: "https://www.frequencyaccess.com/privacy.html",
    ...
    apps: [
        {
            ...
            cookies: [
                ...
                [/^_pk_.*$/, "/", ".amplicaaccess.com", "frequencyaccess.com"], //for the production version
