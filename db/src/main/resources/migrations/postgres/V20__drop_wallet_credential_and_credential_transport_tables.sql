DROP TABLE wallet, credential, credential_transport;
...
-- Each wallet has cross signatures between that wallet's account key, and a credential
...
(
    ...
    last_modified                               BIGINT        NOT NULL,
    version                                     BIGINT        NOT NULL,
    -- A wallet has many credentials but a credential cannot be shared between wallets
