...
input_csv_file = sys.argv[1] or "revokeDelegation.csv"
output_csv_file = sys.argv[2] or "revokeDelegationOutput.csv"

# Define the API endpoint URL
url_base = os.environ.get('DELETE_USER_URL_BASE') or "http://localhost:8080"
api_url = url_base + "/api/admin/revokeDelegationAndHandle"

# Define the global secret key
shared_secret = os.environ.get('DELETE_USER_SHARED_SECRET') or "shared_secret"

print("Revoking Delegation and Handle with data from: " + input_csv_file)
